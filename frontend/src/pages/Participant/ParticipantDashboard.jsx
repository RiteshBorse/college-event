      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="group relative bg-gray-800/50 backdrop-blur-sm p-8 rounded-3xl border border-gray-700 hover:border-green-500 transition-all duration-500 hover:scale-105">
            <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <div className="relative z-10">
              <div className="text-5xl mb-4 transform group-hover:scale-110 transition-transform duration-300">⭐</div>
            ...
            <div className="relative z-10">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-transparent bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text transition-all duration-300">
                    Browse All Events
                  </h3>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-start gap-6">
                <div className="text-6xl transform group-hover:scale-110 transition-transform duration-300">📋</div>
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text transition-all duration-300">
                    My Registrations
                  </h3>
                  <p className="text-gray-400 text-lg mb-6 leading-relaxed">
        ...
        <div className="relative bg-gray-800/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-700 overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl font-bold text-white mb-8 text-center">
              Pro <span className="bg-gradient-to-r from-green-400 to-yellow-400 bg-clip-text text-transparent">Tips</span> for Success
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <h3 className={`text-xl font-bold bg-gradient-to-r ${tip.color} bg-clip-text text-transparent mb-3`}>
                    {tip.title}
                  </h3>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-full text-blue-400 text-sm font-semibold">
            <span>✨</span>
