        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-transparent bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text transition-all duration-300">
                Add New Event
              </h3>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              <div className="text-6xl mb-4 transform group-hover:scale-110 transition-transform duration-300">📋</div>
              <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-transparent bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text transition-all duration-300">
                View All Events
              </h3>
                ...
                <div className="relative bg-gray-800/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-700 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-linear-to-r from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center text-xl">
                        📅
                      </div>
                      <div>
